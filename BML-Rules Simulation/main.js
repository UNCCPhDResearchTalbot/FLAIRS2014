...
function startGame() {
	...
	var HO = null;
	var fulld = new Date();
var fulllog = fs.createWriteStream('logs/full'+(BML?'BML':'Rules')+(ACCURACY*100)+'log'+(fulld.getMonth() + 1 ) + "." + fulld.getDate() + "." + fulld.getFullYear() + " " + fulld.getHours() + "." + fulld.getMinutes() + "." + fulld.getSeconds() +'.csv', {
			'flags' : 'a'
		});
